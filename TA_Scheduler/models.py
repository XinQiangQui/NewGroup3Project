...
class Course2(models.Model):
    course_id = models.AutoField('Course2 Id (Autogenerated)', primary_key=True)
    course_code = models.CharField('Course2 Code', max_length=4, blank=True)
    course_name = models.TextField('Course2 Name', max_length=40, blank=False)
